...
def simulated_annealing(cities, initial_temperature=10000, cooling_rate=0.99, stopping_temperature=1):
    ...
    while temperature > stopping_temperature:
        ...
        print(math.exp((current_length - new_length) / temperature))
        ...
        sim_path_lenghts.append(current_length)
        # Cool down the temperature
        temperature *= cooling_rate
    
    return best_path, best_length

def tabu_search(cities, initial_solution, max_iterations=150, tabu_size=10):
    ...
    for iteration in range(max_iterations):
        ...
        for neighbor in neighborhood:
            ...
            taboo_path_lenghts.append(new_distance)
            # Check tabu list
...
def test_taboo():
    ...
    visualize_path(cities, sa_path, "Simulated Annealing Algorithm")
    plt.figure()
    plt.plot(sim_path_lenghts, label='Path leng SA')
    plt.figure()
    plt.plot(taboo_path_lenghts, label='Path leng TABOO')
    plt.title("VERSUS")
    plt.legend()
    plt.show()
